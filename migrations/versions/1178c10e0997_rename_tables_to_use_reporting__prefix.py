...
def upgrade() -> None:
    ...
    # First drop the old tables to remove references to the enums
    op.drop_table('results')
    op.drop_table('analyses')
    op.drop_table('file_uploads')
    
    # Now create the new tables (enums will be reused)
